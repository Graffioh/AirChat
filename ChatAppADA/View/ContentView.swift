...
struct ContentView: View {    
    ...
    @State var user: User = User(id: "", fullName: "", picked: true)
    ...
    var body: some View {
        ...
        }.fullScreenCover(isPresented:  $shouldShowOnboarding,content: { OnboardingView(shouldShowOnboarding: $shouldShowOnboarding, userSelected: $user).environmentObject(dbManager)})
    }
}
